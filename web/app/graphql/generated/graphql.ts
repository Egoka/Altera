...
export type GetAdminArticlesQuery = { articles: { articles: Array<{ id: string, title: string, slug: string, status: ArticleStatus, publishedAt: string | null, updatedAt: string, author: { name: string, slug: string, email: string }, contentType: { name: string, slug: string } }>, pagination: { currentPage: number, totalPages: number, totalItems: number, itemsPerPage: number, hasNextPage: boolean, hasPreviousPage: boolean } } };
...
export type VerifyMagicLinkMutation = { verifyMagicLink: { accessToken: string, refreshToken: string, user: { id: string, name: string, email: string, role: Role, slug: string } } };
...
export type GetUserMenuQuery = { me: { id: string, name: string, slug: string, photoUrl: string | null, role: Role } | null };
...
export type GetMyProfileQuery = { me: { id: string, name: string, email: string, bio: string | null, photoUrl: string | null, role: Role, slug: string, socialLinks: unknown, createdAt: string } | null, myArticlesStats: { total: number, published: number, draft: number, review: number, archived: number } | null };
...
export type GetAuthorPageQuery = { user: { id: string, name: string, email: string, bio: string | null, photoUrl: string | null, role: Role, slug: string, socialLinks: unknown, createdAt: string, updatedAt: string } | null, articlesByAuthor: { totalCount: number, totalPages: number, currentPage: number, articles: Array<{ id: string, title: string, slug: string, dek: string | null, excerpt: string | null, featuredImage: string | null, publishedAt: string | null, sectionTags: Array<{ name: string, slug: string }>, author: { name: string, slug: string, photoUrl: string | null }, contentType: { name: string, slug: string } }> }, authorStats: { totalArticles: number, articlesThisMonth: number, popularTags: Array<{ name: string, slug: string }> | null } | null };

export type GetHomePageArticlesQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHomePageArticlesQuery = { featuredArticles: Array<{ id: string, title: string, slug: string, dek: string | null, excerpt: string | null, featuredImage: string | null, publishedAt: string | null, author: { name: string, slug: string, photoUrl: string | null }, contentType: { name: string, slug: string } }>, latestArticles: Array<{ id: string, title: string, slug: string, dek: string | null, excerpt: string | null, featuredImage: string | null, publishedAt: string | null, sectionTags: Array<{ name: string, slug: string }>, author: { name: string, slug: string, photoUrl: string | null }, contentType: { name: string, slug: string } }>, popularArticles: Array<{ id: string, title: string, slug: string, author: { name: string, slug: string }, contentType: { name: string, slug: string } }> };
...
export type GetTagPageQuery = { tag: { id: string, name: string, slug: string, description: string | null } | null, articlesByTag: { totalCount: number, totalPages: number, currentPage: number, articles: Array<{ id: string, title: string, slug: string, dek: string | null, excerpt: string | null, featuredImage: string | null, publishedAt: string | null, author: { name: string, slug: string, photoUrl: string | null }, contentType: { name: string, slug: string } }> } };
