...
export type VerifyMagicLinkMutation = { verifyMagicLink: { outcome: VerifyOutcome, next: string | null, isNewAccount: boolean, termsVersion: number | null, privacyVersion: number | null, appealToken: string | null, session: { accessToken: string, refreshToken: string, user: { id: string, name: string, email: string, role: Role, handle: string, locale: Locale } } | null } };
...
export type VerifyOutcomeFragment = { outcome: VerifyOutcome, next: string | null, isNewAccount: boolean, termsVersion: number | null, privacyVersion: number | null, appealToken: string | null, session: { accessToken: string, refreshToken: string, user: { id: string, name: string, email: string, role: Role, handle: string, locale: Locale } } | null };
