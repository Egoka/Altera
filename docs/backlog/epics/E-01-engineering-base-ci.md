...
| [T-002](../tasks/T-002-test-infrastructure.md) | Тестовая инфраструктура: Vitest в server и web, Playwright smoke | завершена | T-001 |
...
| [T-112](../tasks/T-112-launch-e2e-scenarios.md) | Подготовка e2e-сценариев запуска по flow-спецификациям | кандидат | T-002 |
