...
- «биллинг с этапа 1» (D10, строки 29, 109) — платность отдельным этапом (журнал §24.1);
- AI-оценка в рейтинге, `ArticleBoost`, секции главной (строки 145, 149, 164, 172, 226, 251, 254, 290) — журнал §21–§22;
- «владелец один» (строка 187) — журнал #10;
- поиск на PostgreSQL FTS и «ЮKassa или Т-Касса» — Meilisearch (журнал §21.21), Т-Касса первой (§8.14).
