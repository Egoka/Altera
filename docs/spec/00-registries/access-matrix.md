...
| 115 | `account.appeal.decide` | решение по оспариванию: восстановить аккаунт (#105) или подтвердить постоянную блокировку; пользователю уходит уведомление (журнал #48) | — | — | — | — | — | — | ✓ | ✓ | role(admin) | `user.appeal.decide` (`decision`, `reason`) | `FORBIDDEN`, `CONFLICT` | `10-flows/archive-account.md` | утверждён |
