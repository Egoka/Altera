...
| 21 | `payment.refund` | audit | — | api | analyst, admin, owner | `paymentId`, `amountMinor`, `reason`; период не сокращается | бессрочно | `/admin/audit` | `70-plans-and-billing/refunds.md` | утверждён |
