...
| Шаг 3 | рубрика не выбрана; обложки нет (§29.1); перед первой публикацией нет публичного имени или адреса профиля | `VALIDATION_ERROR` с указанием (§25.3–4, §29.1) | подача |
