...
| 3 | список раздела | видит, что сущности нет; в аудите — запись | публичные адреса — 404 (не 410: сущности нет `[ДОПУЩЕНИЕ]`); слаг и хэндл остаются занятыми навсегда, повторно не используются (журнал §26.10) | — | `admin.change` (#75) |
...
- `[ДОПУЩЕНИЕ]` Состав каскада по типам; 404 вместо 410; обезличивание платежей; агрегаты
  остаются; уведомление по 152-ФЗ.
...
- Закрыто Г7 (§26.10): слаги и хэндлы уникальны навсегда — ни архив, ни удаление навсегда не
  освобождают адрес.
